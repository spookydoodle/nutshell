...
export const instantiateSlideshows = (): void => {
    const coinflowSlideshow = new CoinflowSlideshow({ startDelay: 3000, animationsInitialized: false, duration: 5000 });
    const solarSlideshow = new SolarSlideshow({ startDelay: 3000, animationsInitialized: false, duration: 5000 });
